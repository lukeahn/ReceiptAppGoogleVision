...
public class Tags extends TableImpl<TagsRecord> {
	...
	private static final long serialVersionUID = -1491950709;
	...
	/**
	 * The column <code>public.tags.tag_value</code>.
	 */
	public final TableField<TagsRecord, String> TAG_VALUE = createField("tag_value", org.jooq.impl.SQLDataType.VARCHAR.length(225), this, "");
