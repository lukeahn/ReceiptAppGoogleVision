...
public class CreateReceiptRequestTest {
    ...
    @Test
    public void testMerchantNameSavedCorrectlyInReceiptObject() {
        CreateReceiptRequest receipt = new CreateReceiptRequest();
        String merchantName = "Papa John";
        receipt.merchant = merchantName;

        validator.validate(receipt);
        assertEquals(merchantName,receipt.merchant);
    }
}